...
var Upload = function (props) {
    ...
    var post = function (file) {
        ...
        axios.post(action, formData, {
            headers: __assign(__assign({}, headers), { 'Content-Type': 'nultipart/form-data' }),
    ...
    return (React.createElement("div", { role: "upload", className: "viking-upload-component", style: { display: 'inline-block' }, onClick: handleClick },
        drag ?
            ...
            :
                children,
        React.createElement("input", { role: "fileInput", className: "viking-file-input", style: { display: 'none' }, ref: fileInput, type: "file", onChange: handleFileChange, accept: accept, multiple: multiple }),
